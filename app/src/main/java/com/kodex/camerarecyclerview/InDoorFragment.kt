...
import com.kodex.camerarecyclerview.databinding.FragmentInDoorBinding
...
class InDoorFragment: Fragment() {
    ...
    private var _binding: FragmentInDoorBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentInDoorBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val url = getString(R.string.rtspUrl85)
